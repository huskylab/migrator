...
$db_config_new = [
    ...
    'user'   => 'gb_x_aleks59f',
    'pass'   => 'JG5Wq4CYui-K',
    'name'   => 'gb_x_aleks59f', // Важно: база должна быть уже создана и пуста
];

// --- Настройки миграции ---
$export_dir = 'migration_dump'; // Папка для SQL файлов (будет создана рядом со скриптом)
$table_to_chunk = 'amtbd_posts';   // Таблица, которую будем делить на части
$chunk_size = 5000;             // Количество строк в одной части (рекомендую начать с 2000-5000)

// --- Настройки для ЗАМЕНЫ ДОМЕНА ---
$old_domain = 'http://aleksin-amt.ru';
$new_domain = 'https://алексин-амт.рф';
...
$tables_for_replace = [
    'amtbd_Husky_clicks' => ['file_url'],
    'amtbd_Spider_Video_Player_playlist' => ['thumb'],
    'amtbd_Spider_Video_Player_video' => ['thumb'],
    'amtbd_doc_scanner_table' => ['doc_url', 'doc_page', 'doc_title'],
    'amtbd_fv_player_videos' => ['src', 'splash'],
    'amtbd_huge_itslider_images' => ['image_url'],
    'amtbd_nextend2_image_storage' => ['image'],
    'amtbd_nextend2_smartslider3_slides' => ['slide', 'params'],
    'amtbd_nxs_log' => ['extInfo'],
    'amtbd_options' => ['option_value'],
    'amtbd_postmeta' => ['meta_value'],
    'amtbd_posts' => ['post_content', 'post_excerpt', 'guid'],
    'amtbd_redirection_404' => ['url', 'domain', 'referrer'],
    'amtbd_redirection_items' => ['action_data'],
    'amtbd_wdpslayer' => ['link'],
    'amtbd_wdpsslide' => ['image_url', 'thumb_url'],
    'amtbd_wdpsslider' => ['right_butt_url', 'left_butt_url', 'right_butt_hov_url', 'left_butt_hov_url', 'bullets_img_main_url', 'bullets_img_hov_url', 'play_butt_url', 'play_butt_hov_url', 'paus_butt_url', 'paus_butt_hov_url'],
    'amtbd_wfhits' => ['URL'],
    'amtbd_wfnotifications' => ['html'],
    'cerber_traffic' => ['uri'],
